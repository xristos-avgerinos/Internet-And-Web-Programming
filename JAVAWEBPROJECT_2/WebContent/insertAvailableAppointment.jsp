...
<title>Insert Available Appointment</title>
</head>
<body>
...
<div>
 ...
 <input type="button" onclick="location.href='doctorProfile.jsp';" value="Back to Profile" class="myButton" style="float:right;top:5%;"/>
    ...
    <form method="POST" action='DoctorServlet' name="frmInsertAvailableAppointment">
		<label for="date"> Date:</label>
        <input type="date" id="date" name="date"  min="" max="2030-12-31" required> <br /> 
        <label for="sst"> StartSlotTime:</label>
        <input type="time" step="1800" name="StartSlotTime" id="sst" onChange="myFunction()" min="08:00" max="23:00" required> <br /> 
        <label for="est"> EndSlotTime:</label>
        <input type="text" readonly  name="EndSlotTime" id="est" required> <br /> 

   		<input type="submit" value="Submit" name = "insertAvailableAppointment" />
   </form>
    <script>
		var today = new Date();
